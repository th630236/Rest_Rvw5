    ...
    public class AccountController : Controller // Gartenkraft made no change to this class.  I have made additions to it.  (Tim H Note)
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                {
                    string callbackUrl = await SendEmailConfirmationTokenAsync(user.Id, "Confirm your restaurant review account-Resend");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    string callbackUrl = await SendEmailConfirmationTokenAsync(user.Id, "Confirm your restaurant review account");
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Reset Restaurant Review Password", "Please reset your restaurant review password by clicking <a href=\"" + callbackUrl + "\">here</a>");
        ...
        private async Task<string> SendEmailConfirmationTokenAsync(string userID, string subject)
        {
            ...
            await UserManager.SendEmailAsync(userID, subject, "Please confirm your restaurant review account by clicking  <a href=\"" + callbackUrl + "\">here</a>");
